	...
	<div class="dialog-overlay">
		...
		<div class="dialog-panel" role="alertdialog" aria-modal="true">
			<div style="padding:22px 24px 6px">
				<div style="font:600 16px/1.3 'IBM Plex Sans',sans-serif;color:var(--ink)">{title}</div>
				<div style="margin-top:8px;font:400 13px/1.55 'IBM Plex Sans',sans-serif;color:var(--text-muted)">{body}</div>
			</div>
