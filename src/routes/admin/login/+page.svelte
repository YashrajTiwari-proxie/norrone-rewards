...
<div style="min-height:100vh;background:var(--ink);display:grid;place-items:center;padding:40px;font-family:'IBM Plex Sans',sans-serif">
	<div style="width:100%;max-width:392px">
		<div style="display:flex;align-items:center;gap:10px;margin-bottom:34px;justify-content:center">
			<div style="width:26px;height:26px;background:var(--paper);border-radius:3px"></div>
			<div style="font:600 15px/1 'IBM Plex Sans',sans-serif;letter-spacing:-.01em;color:var(--paper)">
				Norrone Platform Admin
			</div>
		</div>
		<div style="background:var(--ink-2);border:1px solid var(--ink-3);border-radius:12px;padding:32px">
			<div style="font:600 21px/1.2 'IBM Plex Sans',sans-serif;color:var(--paper);letter-spacing:-.01em">
				Admin sign in
			</div>
			<div style="margin-top:8px;font:400 14px/1.5 'IBM Plex Sans',sans-serif;color:var(--ink-4)">
			...
			{#if errorMessage}
				<div style="margin-top:14px;font:400 13px 'IBM Plex Sans',sans-serif;color:#F4A48A">{errorMessage}</div>
			{/if}
		</div>
		<div style="margin-top:20px;font:400 12px/1.6 'IBM Plex Sans',sans-serif;color:var(--ink-4);text-align:center">
