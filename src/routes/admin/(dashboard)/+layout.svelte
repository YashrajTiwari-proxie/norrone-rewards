...
{#if isAdmin.isLoading}
	<div style="min-height:100vh;display:grid;place-items:center;font-family: 'Geist', sans-serif">Loading…</div>
{:else if !isAdmin.data}
	<div style="min-height:100vh;display:grid;place-items:center;font-family: 'Geist', sans-serif;text-align:center">
		<div>
			<div style="font:600 18px 'Bodoni Moda', serif">Not a platform admin</div>
...
{:else}
	<div style="display:flex;min-height:100vh;background:var(--paper);font-family: 'Geist', sans-serif;color:var(--text)">
		<div
		...
		>
			<div style="padding:22px 18px 18px">
				<div style="display:flex;align-items:center;gap:9px">
					...
					<div style="font:600 14px/1 'Geist', sans-serif;color:var(--paper);letter-spacing:-.01em">
						Platform Admin
					</div>
				</div>
			</div>
			...
			<div style="padding:6px 10px 0">
				<a
					href="/admin"
					style="display:flex;align-items:center;padding:9px 10px;border-radius:8px;text-decoration:none;font:500 13px 'Geist', sans-serif;color:{onOrgsList
						? 'var(--paper)'
				...
				<a
					href="/admin/regions"
					style="display:flex;align-items:center;padding:9px 10px;border-radius:8px;text-decoration:none;font:500 13px 'Geist', sans-serif;color:{onRegions
						? 'var(--paper)'
			...
			<div style="margin-top:auto;padding:16px 18px;border-top:1px solid var(--ink-2)">
				...
				<div style="margin-top:6px;font:500 13px/1.3 'Geist', sans-serif;color:var(--paper)">
