...
<div style="min-height:100vh;background:var(--paper);display:grid;place-items:center;padding:40px;font-family:'IBM Plex Sans',sans-serif">
	<div style="width:100%;max-width:392px">
		...
		<div class="card" style="padding:32px">
			<div style="font:600 21px/1.2 'IBM Plex Sans',sans-serif;color:var(--ink);letter-spacing:-.01em">Sign in</div>
		...
		<div style="margin-top:20px;font:400 12px/1.6 'IBM Plex Sans',sans-serif;color:var(--text-muted);text-align:center">
