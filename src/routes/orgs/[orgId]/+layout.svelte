...
{:else if org.error}
	<div style="min-height:100vh;display:grid;place-items:center;font-family: 'Inter', sans-serif">
...
{:else if !org.data}
	<div style="min-height:100vh;display:grid;place-items:center;font-family: 'Inter', sans-serif;text-align:center">
		<div>
			<div style="font:600 18px 'Plus Jakarta Sans',sans-serif">Organization not found</div>
