	...
	<div style="width:100%;max-width:420px">
		...
		<div class="card" style="padding:32px">
			{#if convexAuth.isLoading}
				<div style="padding:20px 0;text-align:center;color:var(--text-muted);font:400 14px 'Geist', sans-serif">
					Loading…
				</div>
			{:else}
			...
			<div style="font:500 11px/1 'Geist', sans-serif;letter-spacing:.08em;text-transform:uppercase;color:var(--text-muted)">
				Step {step} of 2
			</div>
			...
			{#if step === 1}
				...
				<form onsubmit={submitAccount} style="margin-top:24px;display:flex;flex-direction:column;gap:16px">
					...
					<label class="field">
						...
						<span style="margin-top:5px;font:400 12px 'Geist', sans-serif;color:var(--text-muted)">At least 8 characters.</span>
					</label>
					<label class="field">
